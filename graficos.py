...
# Colores personalizados diferentes a los de tu compañero
wave_color = '#2E86AB'  # Azul diferente
prob_color = '#5F00BA'  # Rojo diferente
pot_color = '#353535'   # Gris oscuro
...
for n in range(4):
    ...
    # Graficar función de onda con un estilo ligeramente diferente
